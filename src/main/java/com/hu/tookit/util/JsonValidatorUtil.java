...
public class JsonValidatorUtil {
    ...
    private static boolean value() {
        return literal("true") || literal("false") || literal("null") || string() 
        		|| number() || object() || array();
    }
...
//        String jsonStr = "{\"userModel\":{\"userId\":-1,\"loginName\":\"你好\"},"
//        		+ "\"expireTime\":1519723063052,\"createTime\":1519723063052,\"id\":-1,\"userId\":-1,\"token\":\"ABSDsss66789GGHH\"}";
//        System.out.println(jsonStr+":"+ JsonValidatorUtil.validate(jsonStr));
//    }
}
